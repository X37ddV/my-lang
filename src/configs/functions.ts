...
const FUNCTION_ORDER = new MyCompletion();
FUNCTION_ORDER.label = "FUNCTION_ORDER";
FUNCTION_ORDER.insertText = "";

const FUNCTION_TYPE = new MyCompletion();
...
const KEYWORD = new MyCompletion();
...
const MARKET_TYPE = new MyCompletion();
