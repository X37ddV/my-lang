export default {
    "#CALL": {
        ...
        "markettype": 1,
        "modifytime": "20240201",
        "param": "CODE合约名FORMULA引用模型名VAR定义变量名",
        "tip": "#CALL[CODE,FORMULA]ASVAR引用CODE合约的指标FORMULA的数据",
        "type": 1
    },
    "#CALL_OTHER": {
        "body": "#CALL_OTHER [ ] AS",
        ...
        "markettype": 1,
        "modifytime": "",
        "param": "FORMULA引用模型名VAR定义变量名",
        "tip": "#CALL_OTHER[FORMULA]ASVAR跨指标引用",
        "type": 1
    },
    "#CALL_PLUS": {
        "body": "#CALL_PLUS [ , , , ] AS",
        ...
        "modifytime": "20240201",
        "param": "CODE合约名FORMULA引用模型名VAR定义变量名",
        "tip": "#CALL_PLUS[CODE,PERIOD,N,FORMULA]ASVAR引用CODE合约PERIOD参数为N的周期下的指标FORMULA的数据",
        "type": 1
    },
    "#IMPORT": {
        "body": "#IMPORT [ , , ] AS",
        ...
        "markettype": 1,
        "modifytime": "20220304",
        "param": "PERIOD周期N参数FORMULA引用模型名VAR定义变量名",
        "tip": "#IMPORT[PERIOD,N,FORMULA]ASVAR引用PERIOD参数为N的周期下的指标FORMULA的数据",
        "type": 1
    },
    "$": {
        "body": " $ ",
    ...
    "ADMA": {
        ...
        "modifytime": "",
        "param": "",
        "tip": "AMA(X,N,P,Q),考夫曼均值X为调用的k线数据（例如高、开、低，收），N为调用的间隔时间P为快线频率参数，Q为慢线频率参数",
        "type": 3
    },
    "ALIGN": {
        "body": "ALIGN",
        ...
        "modifytime": "",
        "param": "",
        "tip": "ALIGN0,ALIGN1,ALIGN2,分别表示文字左对齐，居中对齐，右对齐",
        "type": 8
    },
    "ALIGN0": "ALIGN0 左对齐",
    "ALIGN1": "ALIGN1 居中对齐",
    ...
    "AVAILABLE_OPI": {
        ...
        "modifytime": "20240220",
        "param": "",
        "tip": "AVAILABLE_OPI可用股数",
        "type": 12
    },
    "AVEDEV": {
        "body": "AVEDEV( , )",
        "createtime": "2014-04-30",
    ...
    "BACKGROUNDSTYLE": {
        ...
        "modifytime": "",
        "param": "i=0或1",
        "tip": "BACKGROUNDSTYLE(i)设置背景的样式,i=0、1、2",
        "type": 8
    },
    "BARINTERVAL": {
        "body": "BARINTERVAL",
    ...
    "BARSCOUNT": {
        ...
        "modifytime": "",
        "param": "",
        "tip": "BARSCOUNT(COND)返回COND第一个有效值的位置到当前的周期数",
        "type": 2
    },
    "BARSLAST": {
        "body": "BARSLAST( )",
        ...
        "modifytime": "",
        "param": "",
        "tip": "BARSLAST(X),求上一次条件X满足到现在的周期数",
        "type": 2
    },
    "BARSLASTCOUNT": {
        "body": "BARSLASTCOUNT()",
    ...
    "BARSSINCEN": {
        ...
        "modifytime": "",
        "param": "",
        "tip": "BARSSINCEN统计N周期内第一次条件成立到当前的周期数",
        "type": 2
    },
    "BARSSK": {
        "body": "BARSSK",
    ...
    "BARSTATUS": {
        ...
        "modifytime": "",
        "param": "",
        "tip": "BARSTATUS返回当前周期的位置状态。1表示当前周期是第一个周期，2表示是最后一个周期，0表示当前周期处于中间位置。",
        "type": 8
    },
    "BARTYPE": {
        "body": "BARTYPE",
    ...
    "BETWEEN": {
        ...
        "modifytime": "",
        "param": "",
        "tip": "BETWEEN(A,B,C),A处于B和C之间时取1(Yes)，否则取0(No)",
        "type": 5
    },
    "BK": "BK 买开仓",
    "BKHIGH": {
    ...
    "BUYPRICE": {
        "body": "BUYPRICE",
        "createtime": "20221201",
        "description": "BUYPRICE 返回最近一次买入信号所在K线的收盘价。\\r\\n\\r\\n用法：\\r\\nBUYPRICE 返回最近一次买入信号所在K线的收盘价。\\r\\n\\r\\n注：\\r\\n1、该函数支持在股票T+1策略运行池中使用。\\r\\n\\r\\n例:\\r\\nBUYPRICE-CLOSE>60 && BUYPRICE>0 && BUYVOL>0, SELL;//如果买入价位比当前价位高出60,且多头持仓存在，卖出持仓。",
        "explanation": "返回最近一次买入信号所在K线的收盘价。",
        "markettype": 2,
        "modifytime": "20221205",
        "param": "",
        "tip": "BUYPRICE  返回最近一次买入信号所在K线的收盘价。",
        "type": 10
    },
    "C": "C 收盘价",
    "CANCEL_ORDER": "CANCEL_ORDER 启用自动撤单并终止下单",
    "CEILING": {
        "body": "CEILING( , )",
        "createtime": "",
        ...
        "modifytime": "",
        "param": "",
        "tip": "CEILING(X,Y)返回指定实数(X)在沿绝对值增大的方向上第一个能整除基数(Y)的值。",
        "type": 4
    },
    "CHECKSIG": {
        "body": "CHECKSIG( , , , , ,)",
        ...
        "modifytime": "20230208",
        "param": "",
        "tip": "CHECKSIG(SIG,MODE1,TIME1,MODE2,TIME2,INTERVAL);设置信号确认与复核的指令价方式（TICK逐笔回测，可设置回测精度）SIG为信号,MODE1为下单方式,TIME1下单确认时间,MODE2复核方式,TIME2复核确认时间,INTERVAL代表数据时间间隔",
        "type": 13
    },
    "CHECKSIG_MIN": {
        "body": "CHECKSIG_MIN( , , , ,)",
        ...
        "modifytime": "20220106",
        "param": "",
        "tip": "CHECKSIG_MIN(SIG,MODE1,TIME1,MODE2,TIME2);设置信号确认与复核的指令价方式（逐分钟回测）SIG为信号,MODE1为下单方式,TIME1下单确认时间,MODE2复核方式,TIME2复核确认时间",
        "type": 13
    },
    "CIRCLEDOT": {
        "body": "CIRCLEDOT",
    ...
    "CLOSEMINUTEEVERY1": {
        ...
        "modifytime": "20221206",
        "param": "",
        "tip": "CLOSEMINUTEEVERY1(N),返回当前时间距离每个小节结束的时间（单位：分钟），N为第几个小节，方便小节前及时平仓",
        "type": 7
    },
    "CLOSEOUT": "CLOSEOUT，清仓指令，平掉所有方向的持仓",
    "CLOSESEC": {
        "body": "CLOSESEC",
        "createtime": "20141031",
        ...
        "modifytime": "20230707",
        "param": "",
        "tip": "CLOSESEC,返回K线开始时间距离闭市前的时间（单位：秒），方便闭市前及时平仓",
        "type": 7
    },
    "CLOSESEC1": {
        "body": "CLOSESEC1",
        ...
        "modifytime": "20230707",
        "param": "",
        "tip": "CLOSESEC1,返回当前时间距离闭市前的时间（单位：秒），方便闭市前及时平仓",
        "type": 7
    },
    "CLOSESECEVERY": {
        "body": "CLOSESECEVERY()",
        ...
        "modifytime": "",
        "param": "",
        "tip": "CLOSESECEVERY(N),返回K线开始时间距离每个小节结束的时间（单位：秒），N为第几个小节，方便小节前及时平仓",
        "type": 7
    },
    "CLOSESECEVERY1": {
        "body": "CLOSESECEVERY1()",
        ...
        "modifytime": "",
        "param": "",
        "tip": "CLOSESECEVERY1(N),返回当前时间距离每个小节结束的时间（单位：秒），N为第几个小节，方便小节前及时平仓",
        "type": 7
    },
    "CMPETITV_ORDER": "CMPETITV_ORDER 超价",
    "CODELIKE": {
        "body": "CODELIKE('')",
        "createtime": "20161216",
        ...
        "modifytime": "",
        "param": "",
        "tip": "CODELIKE('')模糊股票代码函数。CODELIKE('600')判断股票代码是否以600开头。是返回1（YES）,不是返回0（NO）。",
        "type": 5
    },
    "COEFFICIENTR": {
        "body": "COEFFICIENTR( , , )",
        ...
        "modifytime": "",
        "param": "",
        "tip": "COEFFICIENTR(X,Y,N)求X、Y在N个周期内的皮尔森相关系数",
        "type": 3
    },
    "COLORBLACK": "COLORBLACK 黑色",
    "COLORBLUE": "COLORBLUE 蓝色",
    "COLORCYAN": "COLORCYAN 青色",
    "COLORGRAY": "COLORGRAY 灰色",
    "COLORGREEN": "COLORGREEN 绿色",
    "COLORLIGHTBLUE": "COLORLIGHTBLUE 浅蓝色",
    "COLORLIGHTGREEN": "COLORLIGHTGREEN 浅绿色",
    "COLORLIGHTGREY": "COLORLIGHTGREY 浅灰色",
    "COLORLIGHTRED": "COLORLIGHTRED 浅红色",
    "COLORMAGENTA": "COLORMAGENTA 紫红色",
    "COLORRED": "COLORRED 红色",
    "COLORSTICK": {
        "body": "COLORSTICK",
        "createtime": "",
        ...
        "modifytime": "",
        "param": "",
        "tip": "COLORSTICK画柱线，大于0为红色，小于0为青色",
        "type": 8
    },
    "COLORWHITE": "COLORWHITE 白色",
    "COLORYELLOW": "COLORYELLOW 黄色",
    "CONDBARS": {
        "body": "CONDBARS(,)",
        "createtime": "",
        ...
        "modifytime": "",
        "param": "",
        "tip": "CONDBARS(A,B),取得最近满足A、B条件的k线间周期数",
        "type": 2
    },
    "COS": {
        "body": "COS( )",
    ...
    "COUNT": {
        ...
        "modifytime": "",
        "param": "N为周期",
        "tip": "COUNT(X,N),统计N周期中满足X条件的周期数。若N为0则从第一个周期开始",
        "type": 2
    },
    "COUNTGROUPSIG": {
        "body": "COUNTGROUPSIG( , , )",
        ...
        "modifytime": "20211229",
        "param": "",
        "tip": "COUNTGROUPSIG(X,N,'group');统计N周期内,分组为group的X信号的数量X可以为BK、SK、SP、BP、SPK、BPK、CLOSEOUT、STOP",
        "type": 10
    },
    "COUNTSIG": {
        "body": "COUNTSIG(,)",
        ...
        "modifytime": "20211229",
        "param": "",
        "tip": "COUNTSIG(X,N);统计N周期内,X信号的数量X可以为BK、SK、SP、BP、SPK、BPK、CLOSEOUT、STOP",
        "type": 10
    },
    "COVAR": {
        "body": "COVAR( , , )",
        ...
        "modifytime": "",
        "param": "",
        "tip": "COVAR(X,Y,N)求X、Y在N个周期内的协方差",
        "type": 3
    },
    "CROSS": {
        "body": "CROSS( , )",
        ...
        "modifytime": "",
        "param": "",
        "tip": "CROSS(A,B),A从下方向上穿过B时取1(Yes)，否则取0(No)",
        "type": 5
    },
    "CROSS2": {
        "body": "CROSS2( , , )",
        ...
        "modifytime": "",
        "param": "",
        "tip": "CROSS2(A,B,N),表示N个周期内当A从下方向上穿过B的次数为偶数次偶数次时返回1(Yes)，否则返回0(No)",
        "type": 5
    },
    "CROSSDOT": {
        "body": "CROSSDOT",
    ...
    "CROSSDOWN": {
        ...
        "modifytime": "",
        "param": "",
        "tip": "CROSSDOWN(A,B),表示当A从上方向下穿过B时返回1(Yes)，否则返回0(No)",
        "type": 5
    },
    "CROSSUP": {
        "body": "CROSSUP( , )",
        ...
        "modifytime": "",
        "param": "",
        "tip": "CROSSUP(A,B),表示当A从下方向上穿过B时返回1(Yes)，否则返回0(No)",
        "type": 5
    },
    "CUBE": {
        "body": "CUBE( )",
    ...
    "CURRENTTIME": {
        ...
        "modifytime": "",
        "param": "",
        "tip": "CURRENTTIME返回当前的时分秒",
        "type": 7
    },
    "CUSTOM_DAY": "CUSTOM_DAY 自定义日",
    "CUSTOM_HOUR": "CUSTOM_HOUR 自定义小时",
    "CUSTOM_MIN": "CUSTOM_MIN 自定义分钟",
    "CUSTOM_SEC": "CUSTOM_SEC 自定义秒",
    "DASH": {
        "body": "DASH",
        "createtime": "20141121",
    ...
    "DATE": {
        ...
        "modifytime": "",
        "param": "",
        "tip": "DATE,取某周期的日期数（700101-331231）",
        "type": 7
    },
    "DATE1": {
        "body": "DATE1",
    ...
    "DAYSTOEXPIRED": {
        ...
        "modifytime": "20220425",
        "param": "",
        "tip": "DAYSTOEXPIRED(CODE)期货合约距最后交易日的天数,CODE为文华码",
        "type": 7
    },
    "DAYTRADE": {
        "body": "DAYTRADE",
    ...
    "DIVERGENCE": {
        ...
        "modifytime": "",
        "param": "",
        "tip": "DIVERGENCE(X1,X2,S,L,HL);变量X1与X2在指定周期内是否发生背离S:设置转折点两边需要的周期数；L:计算的总的范围的周期数HL为1，表示顶背离，HL为-1，表示底背离",
        "type": 5
    },
    "DIVIDEND": {
        "body": "DIVIDEND()",
        ...
        "modifytime": "",
        "param": "",
        "tip": "DIVIDEND(N)返回之前第N次派息的每股派息数量",
        "type": 15
    },
    "DIVIDENDBARS": {
        "body": "DIVIDENDBARS()",
        ...
        "modifytime": "",
        "param": "",
        "tip": "DIVIDENDBARS(N)返回从之前第N次派息到当前的周期数",
        "type": 15
    },
    "DMA": {
        "body": "DMA( , )",
        ...
        "modifytime": "",
        "param": "A必须小于1大于0",
        "tip": "DMA(X,A),求X的动态移动平均。A必须小于1大于0",
        "type": 2
    },
    "DOT": {
        "body": "DOT",
    ...
    "DRAWBARLINE": {
        ...
        "modifytime": "",
        "param": "",
        "tip": "DRAWBARLINE(H1,O1,L1,C1);在L1到H1之间绘制柱线，在O1位置绘制左侧横线，在C1位置绘制右侧横线",
        "type": 8
    },
    "DRAWBKBMP": {
        "body": "DRAWBKBMP( , )",
        ...
        "modifytime": "",
        "param": "",
        "tip": "DRAWBKBMP(COND,IMAGE);设置背景图片",
        "type": 8
    },
    "DRAWBMP": {
        "body": "DRAWBMP( , )",
    ...
    "DRAWCOLORLINE": {
        ...
        "modifytime": "20211228",
        "param": "",
        "tip": "DRAWCOLORLINE（COND,DATA,COLOR1,COLOR2）;根据条件画相应颜色的线当满足COND时，DATA为COLOR1颜色的线，不满足COND时，DATA为COLOR2颜色的线",
        "type": 8
    },
    "DRAWCOLUMNCHART": {
        ...
        "modifytime": "",
        "param": "",
        "tip": "DRAWCOLUMNCHART(X,C1,C2)，X表示柱高,C1判断柱的方向,C2判断柱的颜色C1条件满足时从0轴向上画柱，不满足时从0轴向下画柱，C2条件满足时柱为红色，不满足时柱为青色",
        "type": 8
    },
    "DRAWGBK": {
        "body": "DRAWGBK(,,,)",
        ...
        "modifytime": "",
        "param": "",
        "tip": "DRAWGBK(COND,C1,C2,D);以C1至C2的渐变色填充背景,D指定渐变方向，0表示从左到右，1表示从上到下",
        "type": 8
    },
    "DRAWGBK1": {
        "body": "DRAWGBK1(,)",
        ...
        "modifytime": "",
        "param": "",
        "tip": "DRAWGBK1(COND,COLOR)当条件COND成立时，以K线宽度、COLOR颜色填充背景区域，高度为整个显示区域的最高到最低",
        "type": 8
    },
    "DRAWICON": {
        "body": "DRAWICON( , , )",
    ...
    "DRAWLASTBARICON": {
        ...
        "modifytime": "",
        "param": "",
        "tip": "DRAWLASTBARICON(PRICE,ICON)最后一根k线,在PRICE位置画图标ICON",
        "type": 8
    },
    "DRAWLASTBARLINE": {
        ...
        "modifytime": "",
        "param": "",
        "tip": "DRAWLASTBARLINE(C1,P1,X1,C2,P2,X2,EXP);最后一根k线满足条件C1时向左偏移X1个周期及最后一根k线满足条件C2时向左偏移X2个周期从P1向P2画线。EXP为0表示画线不延伸，EXP不为0表示画线延伸",
        "type": 8
    },
    "DRAWLASTBARNUMBER": {
        ...
        "modifytime": "",
        "param": "",
        "tip": "DRAWLASTBARNUMBER(DATA,NUMBER,PRECISION,COLOR);最后一根k线,在DATA位置写数字NUMBER",
        "type": 8
    },
    "DRAWLASTBARTEXT": {
        ...
        "modifytime": "",
        "param": "",
        "tip": "DRAWLASTBARTEXT(PRICE,TEXT)最后一根k线,在PRICE位置书写文字TEXT",
        "type": 8
    },
    "DRAWLINE": {
        "body": "DRAWLINE( , , , , )",
        ...
        "modifytime": "",
        "param": "COLOR为颜色",
        "tip": "DRAWLINE(C1,P1,C2,P2,COLOR)满足条件C1时及C2时从P1向P2画线",
        "type": 8
    },
    "DRAWLINE1": {
        "body": "DRAWLINE1( , , , , )",
        ...
        "modifytime": "",
        "param": "",
        "tip": "DRAWLINE1(C1,P1,C2,P2,EXP)满足条件C1时及该K线后最近一个满足C2时从P1向P2画线。EXP为画线0不延伸，EXP不为0画线延伸",
        "type": 8
    },
    "DRAWLINE2": {
        "body": "DRAWLINE2( , , , , )",
        ...
        "modifytime": "",
        "param": "",
        "tip": "DRAWLINE2(C1,P1,C2,P2,EXP)满足条件C1时及之后最后一次满足C2时从P1向P2画线。EXP为画线0不延伸，EXP不为0画线延伸",
        "type": 8
    },
    "DRAWLINE3": {
        "body": "DRAWLINE3(,,,,,,)",
        ...
        "modifytime": "",
        "param": "",
        "tip": "DRAWLINE3(C1,P1,X1,C2,P2,X2,EXP);满足条件C1时向左偏移X1个周期及满足条件C2时向左偏移X2个周期从P1向P2画线。EXP为0表示画线不延伸，EXP不为0表示画线延伸",
        "type": 8
    },
    "DRAWNUMBER": {
        "body": "DRAWNUMBER( , , , , )",
        ...
        "markettype": 0,
        "modifytime": "",
        "param": "PRECISION为精度（小数点后有几位数字）。COLOR为颜色",
        "tip": "DRAWNUMBER(COND,DATA,NUMBER,PRECISION,COLOR)当条件COND满足时在DATA位置写数字NUMBERPRECISION为精度（小数点后有几位数字）。COLOR为颜色",
        "type": 8
    },
    "DRAWNUMBER1": {
        "body": "DRAWNUMBER1( , , , )",
        ...
        "markettype": 0,
        "modifytime": "",
        "param": "PRECISION为精度（小数点后有几位数字）",
        "tip": "DRAWNUMBER1(COND,DATA,NUMBER,PRECISION)当条件满足时在DATA位置写数字NUMBER",
        "type": 8
    },
    "DRAWSHIFTNUMBER": {
        ...
        "modifytime": "",
        "param": "",
        "tip": "DRAWSHIFTNUMBER(COND,DATA,NUMBER,,PRECISION,COLOR,DIRECTION,X);当条件满足时在DATA位置写数字NUMBER。PRECISION为精度（小数点后有几位数字）。COLOR为颜色。DIRECTION为偏移的方向：0左1右,X为偏移的K线根数。",
        "type": 8
    },
    "DRAWSL": {
        "body": "DRAWSL( , , , , , )",
        ...
        "markettype": 0,
        "modifytime": "",
        "param": "EXPAND为画线延长方式0:不延伸；1:向左延伸；2:向右延伸；3:双向延伸。COLOR为颜色",
        "tip": "DRAWSL(COND,DATA,SLOPE,LEN,EXPAND,COLOR),当条件满足时，在DATA数据处以每个周期相差SLOPE个价位作为斜率画LEN个周期长的线段",
        "type": 8
    },
    "DRAWSL1": {
        "body": "DRAWSL1( , , , , )",
        ...
        "markettype": 0,
        "modifytime": "",
        "param": "EXPAND为画线延长方式0:不延伸；1:向左延伸；2:向右延伸；3:双向延伸",
        "tip": "DRAWSL1(COND,DATA,SLOPE,LEN,EXPAND),当条件满足时，在DATA数据处以每个周期相差SLOPE个价位作为斜率画LEN个周期长的线段",
        "type": 8
    },
    "DRAWTEXT": {
        "body": "DRAWTEXT( , , )",
        ...
        "modifytime": "",
        "param": "",
        "tip": "DRAWTEXT(COND,PRICE,TEXT),当COND条件满足时,在PRICE位置书写文字TEXT",
        "type": 8
    },
    "DRAWVALID": {
        "body": "DRAWVALID()",
        "createtime": "20151216",
        "description": "DRAWVALID 连接数据的有效值画折线\\r\\n\\r\\n用法：\\r\\nDRAWVALID(DATA);连接DATA中的有效值画折线\\r\\n注：无效值指的是空值，该函数连接K线图中各个非空值的点\\r\\n\\r\\n例1：DRAWVALID(IFELSE(C>O,H,NULL));//连接K线图中所有阳线的最高价",
        "explanation": "连接数据的有效值画折线",
        "markettype": 1,
        "modifytime": "20220627",
        "param": "",
        "tip": "DRAWVALID(DATA);连接DATA中的有效值画折线",
        "type": 8
    },
    "DUALVOLUME": {
        "body": "DUALVOLUME( )",
        ...
        "modifytime": "",
        "param": "",
        "tip": "DUALVOLUME('M'),返回值代表一段时间内的（主动买-主动卖）的平均数值DUALVOLUME('N'),返回值代表主动买-主动卖的量差",
        "type": 1
    },
    "ELSE": "",
    "EMA": {
    ...
    "ENTRYSIG_PLACE": {
        ...
        "modifytime": "20221107",
        "param": "",
        "tip": "ENTRYSIG_PLACE(N)取一次完整交易第N个开仓信号距离当前K线的位置。",
        "type": 10
    },
    "ENTRYSIG_PRICE": {
        "body": "ENTRYSIG_PRICE()",
        ...
        "modifytime": "20221107",
        "param": "",
        "tip": "ENTRYSIG_PRICE(N)取一次完整交易第N个开仓信号的价格。",
        "type": 10
    },
    "ENTRYSIG_VOL": {
        "body": "ENTRYSIG_VOL()",
        ...
        "modifytime": "20221107",
        "param": "",
        "tip": "ENTRYSIG_VOL(N)取一次完整交易第N个开仓信号的信号手数。",
        "type": 10
    },
    "EVERY": {
        "body": "EVERY( , )",
        ...
        "modifytime": "",
        "param": "",
        "tip": "EVERY(X,N),判断过去一定周期N内，是否一直满足条件X如果一直满足返回1，否则返回0",
        "type": 5
    },
    "EXIST": {
        "body": "EXIST( , )",
        ...
        "modifytime": "",
        "param": "",
        "tip": "EXIST(X,N),判断过去周期N内，是否有满足条件X如果有满足X条件的K线，返回1；如果没有满足X条件的K线，则返回0",
        "type": 5
    },
    "EXITSIG_PLACE": {
        "body": "EXITSIG_PLACE()",
        ...
        "modifytime": "20221107",
        "param": "",
        "tip": "EXITSIG_PLACE(N)取一次完整交易第N个平仓信号距离当前K线的位置。",
        "type": 10
    },
    "EXITSIG_PRICE": {
        "body": "EXITSIG_PRICE()",
        ...
        "modifytime": "20221107",
        "param": "",
        "tip": "EXITSIG_PRICE(N)取一次完整交易第N个平仓信号的价格。",
        "type": 10
    },
    "EXITSIG_VOL": {
        "body": "EXITSIG_VOL()",
        ...
        "modifytime": "20221107",
        "param": "",
        "tip": "EXITSIG_VOL(N)取一次完整交易第N个平仓信号的信号手数。",
        "type": 10
    },
    "EXP": {
        "body": "EXP( )",
    ...
    "EXPIREDATE": {
        ...
        "modifytime": "20230707",
        "param": "",
        "tip": "TIME0求当前周期自该日0点以来的秒数EXPIREDATE(CODE)返回期货合约的最后交易日,CODE为文华码",
        "type": 7
    },
    "FEE": {
        "body": "FEE",
    ...
    "FILLRGN": {
        ...
        "modifytime": "",
        "param": "COLOR为颜色",
        "tip": "FILLRGN(COND,DATA1,DATA2,COLOR),当条件满足时，以颜色COLOR填充DATA1及DATA2之间形成的区域",
        "type": 8
    },
    "FILLRGN1": {
        "body": "FILLRGN1( , , )",
        ...
        "modifytime": "",
        "param": "",
        "tip": "FILLRGN1(COND,DATA1,DATA2),当条件满足时，填充DATA1及DATA2之间的区域",
        "type": 8
    },
    "FILTER": {
        "body": "FILTER( , )",
    ...
    "FONTSIZE10": "FONTSIZE10 字体大小为10",
    "FONTSIZE11": "FONTSIZE11 字体大小为11",
    "FONTSIZE12": "FONTSIZE12 字体大小为12",
    "FONTSIZE13": "FONTSIZE13 字体大小为13",
    "FONTSIZE14": "FONTSIZE14 字体大小为14",
    "FONTSIZE15": "FONTSIZE15 字体大小为15",
    "FONTSIZE16": "FONTSIZE16 字体大小为16",
    "FONTSIZE17": "FONTSIZE17 字体大小为17",
    "FONTSIZE18": "FONTSIZE18 字体大小为18",
    "FONTSIZE19": "FONTSIZE19 字体大小为19",
    "FONTSIZE20": "FONTSIZE20 字体大小为20",
    "FONTSIZE21": "FONTSIZE21 字体大小为21",
    "FONTSIZE22": "FONTSIZE22 字体大小为22",
    "FONTSIZE23": "FONTSIZE23 字体大小为23",
    "FONTSIZE24": "FONTSIZE24 字体大小为24",
    "FONTSIZE25": "FONTSIZE25 字体大小为25",
    "FONTSIZE26": "FONTSIZE26 字体大小为26",
    "FONTSIZE27": "FONTSIZE27 字体大小为27",
    "FONTSIZE28": "FONTSIZE28 字体大小为28",
    "FONTSIZE29": "FONTSIZE29 字体大小为29",
    "FONTSIZE30": "FONTSIZE30 字体大小为30",
    "FONTSIZE31": "FONTSIZE31 字体大小为31",
    "FONTSIZE32": "FONTSIZE32 字体大小为32",
    "FONTSIZE33": "FONTSIZE33 字体大小为33",
    "FONTSIZE34": "FONTSIZE34 字体大小为34",
    "FONTSIZE35": "FONTSIZE35 字体大小为35",
    "FONTSIZE36": "FONTSIZE36 字体大小为36",
    "FONTSIZE37": "FONTSIZE37 字体大小为37",
    "FONTSIZE38": "FONTSIZE38 字体大小为38",
    "FONTSIZE39": "FONTSIZE39 字体大小为39",
    "FONTSIZE40": "FONTSIZE40 字体大小为40",
    "FONTSIZE41": "FONTSIZE41 字体大小为41",
    "FONTSIZE42": "FONTSIZE42 字体大小为42",
    "FONTSIZE43": "FONTSIZE43 字体大小为43",
    "FONTSIZE44": "FONTSIZE44 字体大小为44",
    "FONTSIZE45": "FONTSIZE45 字体大小为45",
    "FONTSIZE46": "FONTSIZE46 字体大小为46",
    "FONTSIZE47": "FONTSIZE47 字体大小为47",
    "FONTSIZE48": "FONTSIZE48 字体大小为48",
    "FONTSIZE49": "FONTSIZE49 字体大小为49",
    "FONTSIZE50": "FONTSIZE50 字体大小为50",
    "FONTSIZE51": "FONTSIZE51 字体大小为51",
    "FONTSIZE52": "FONTSIZE52 字体大小为52",
    "FONTSIZE53": "FONTSIZE53 字体大小为53",
    "FONTSIZE54": "FONTSIZE54 字体大小为54",
    "FONTSIZE55": "FONTSIZE55 字体大小为55",
    "FONTSIZE56": "FONTSIZE56 字体大小为56",
    "FONTSIZE57": "FONTSIZE57 字体大小为57",
    "FONTSIZE58": "FONTSIZE58 字体大小为58",
    "FONTSIZE59": "FONTSIZE59 字体大小为59",
    "FONTSIZE60": "FONTSIZE60 字体大小为60",
    "FONTSIZE61": "FONTSIZE61 字体大小为61",
    "FONTSIZE62": "FONTSIZE62 字体大小为62",
    "FONTSIZE63": "FONTSIZE63 字体大小为63",
    "FONTSIZE64": "FONTSIZE64 字体大小为64",
    "FONTSIZE65": "FONTSIZE65 字体大小为65",
    "FONTSIZE66": "FONTSIZE66 字体大小为66",
    "FONTSIZE67": "FONTSIZE67 字体大小为67",
    "FONTSIZE68": "FONTSIZE68 字体大小为68",
    "FONTSIZE69": "FONTSIZE69 字体大小为69",
    "FONTSIZE70": "FONTSIZE70 字体大小为70",
    "FONTSIZE71": "FONTSIZE71 字体大小为71",
    "FONTSIZE72": "FONTSIZE72 字体大小为72",
    "FONTSIZE8": "FONTSIZE8 字体大小为8",
    "FONTSIZE9": "FONTSIZE9 字体大小为9",
    "FORCAST": {
        "body": "FORCAST( , )",
        "createtime": "2014-04-30",
    ...
    "FUNCTION_ORDER": {
        ...
        "function1": "ABS",
        "function10": "AVEDEV",
        "function100": "DRAWLASTBARLINE",
        "function101": "DRAWLASTBARNUMBER",
        "function102": "DRAWLASTBARTEXT",
        "function103": "DRAWLINE",
        "function104": "DRAWLINE1",
        "function105": "DRAWLINE2",
        "function106": "DRAWLINE3",
        "function107": "DRAWNUMBER",
        "function108": "DRAWNUMBER1",
        "function109": "DRAWSHIFTNUMBER",
        "function11": "AVPRICE",
        "function110": "DRAWSL",
        "function111": "DRAWSL1",
        "function112": "DRAWTEXT",
        "function113": "DRAWVALID",
        "function114": "DUALVOLUME",
        "function115": "EMA",
        "function116": "EMA2",
        "function117": "EMAWH",
        "function118": "ENTRYSIG_PLACE",
        "function119": "ENTRYSIG_PRICE",
        "function12": "BACKGROUNDSTYLE",
        "function120": "ENTRYSIG_VOL",
        "function121": "EVERY",
        "function122": "EXIST",
        "function123": "EXITSIG_PLACE",
        "function124": "EXITSIG_PRICE",
        "function125": "EXITSIG_VOL",
        "function126": "EXP",
        "function127": "EXPIREDATE",
        "function128": "FEE",
        "function129": "FILLRGN",
        "function13": "BARINTERVAL",
        "function130": "FILLRGN1",
        "function131": "FILTER",
        "function132": "FINANCE_DATA",
        "function133": "FLOOR",
        "function134": "FONTSIZE",
        "function135": "FORCAST",
        "function136": "GROUP",
        "function137": "GROUPBKPRICE",
        "function138": "GROUPBKVOL",
        "function139": "GROUPSKPRICE",
        "function14": "BARPOS",
        "function140": "GROUPSKVOL",
        "function141": "HARMEAN",
        "function142": "HASTRADEDATA",
        "function143": "HHV",
        "function144": "HHVBARS",
        "function145": "HIGH",
        "function146": "HISEXPDATE",
        "function147": "HISEXPDAYS",
        "function148": "HOLLOW",
        "function149": "HOUR",
        "function15": "BARSBK",
        "function150": "HV",
        ...
        "function153": "IF",
        "function154": "IFELSE",
        "function155": "IMPLIEDVOLATILITY",
        "function156": "INITMONEY",
        "function157": "INTPART",
        "function158": "ISCONTRACT",
        "function159": "ISDELIVERYDAY",
        "function16": "BARSBP",
        "function160": "ISDOWN",
        "function161": "ISEQUAL",
        "function162": "ISLASTBAR",
        "function163": "ISLASTBK",
        "function164": "ISLASTBP",
        "function165": "ISLASTBPK",
        "function166": "ISLASTBUY",
        "function167": "ISLASTCLOSEOUT",
        "function168": "ISLASTKLINE",
        "function169": "ISLASTSELL",
        "function17": "BARSBUY",
        "function170": "ISLASTSK",
        "function171": "ISLASTSP",
        "function172": "ISLASTSPK",
        "function173": "ISLASTSTOP",
        "function174": "ISMAINCONTRACT",
        "function175": "ISMONTHEND",
        "function176": "ISNEARHOLIDAY",
        "function177": "ISNULL",
        "function178": "ISRECORDDAY",
        "function179": "ISTIMETOKLINEEND",
        "function18": "BARSCOUNT",
        "function180": "ISUP",
        "function181": "ISWEEKEND",
        "function182": "K_STATE",
        "function183": "K_STATE1",
        "function184": "K_STATE2",
        "function185": "K_STATE3",
        "function186": "K_STATE4",
        "function187": "KLINESIG",
        "function188": "KLINESTART",
        "function189": "KTEXT",
        "function19": "BARSLAST",
        "function190": "KURTOSIS",
        "function191": "LAST",
        "function192": "LASTOFFSETPROFIT",
        "function193": "LASTSIG",
        "function194": "LASTSIGGROUP",
        "function195": "LINETHICK",
        "function196": "LLV",
        "function197": "LLVBARS",
        "function198": "LN",
        "function199": "LOG",
        "function2": "ACOS",
        "function20": "BARSLASTCOUNT",
        "function200": "LOG10",
        "function201": "LONGCROSS",
        "function202": "LOOP1",
        "function203": "LOOP2",
        "function204": "LOW",
        "function205": "LV",
        ...
        "function209": "MAX1",
        "function21": "BARSSELL",
        "function210": "MAXBKVOL",
        "function211": "MAXSKVOL",
        "function212": "MEDIAN",
        "function213": "MEDIAN1",
        "function214": "MIN",
        "function215": "MIN1",
        "function216": "MINPRICE",
        "function217": "MINPRICE1",
        "function218": "MINPRICED",
        "function219": "MINUTE",
        "function22": "BARSSINCE",
        "function220": "MOD",
        "function221": "MODE",
        "function222": "MONEY",
        "function223": "MONEYRATIO",
        "function224": "MONEYTOT",
        "function225": "MONTH",
        "function226": "MONTHTRADE",
        "function227": "MONTHTRADE1",
        "function228": "MULTSIG",
        "function229": "MULTSIG_MIN",
        "function23": "BARSSINCEN",
        "function230": "MV",
        "function231": "MYVOL",
        "function232": "NAMELIKE",
        "function233": "NEWHBARS",
        "function234": "NEWHBARS1",
        "function235": "NEWLBARS",
        "function236": "NEWLBARS1",
        "function237": "NODRAW",
        "function238": "NORMPDF",
        "function239": "NOT",
        "function24": "BARSSK",
        ...
        "function241": "NULL",
        "function242": "NUMPOW",
        "function243": "OFFSETPROFIT",
        "function244": "OFFSETPROFIT1",
        "function245": "OPEN",
        "function246": "OPENMINUTE",
        "function247": "OPENMINUTE1",
        "function248": "OPENSEC",
        "function249": "OPENSEC1",
        "function25": "BARSSP",
        "function250": "OPI",
        "function251": "PANZHENG",
        "function252": "PARTLINE",
        "function253": "PARTLINE1",
        "function254": "PCRATE",
        "function255": "PCRATETREND",
        "function256": "PERCENTILE",
        "function257": "PERIOD",
        "function258": "PLAYSOUND",
        "function259": "POINTDOT",
        "function26": "BARSTATUS",
        "function260": "POLYLINE",
        "function261": "POLYLINE1",
        "function262": "POW",
        "function263": "PRECIS",
        "function264": "PRECISION",
        "function265": "PRICEPRECISION",
        "function266": "PRICEPRECISION1",
        "function267": "PROFIT",
        "function268": "QUARTER",
        "function269": "QUARTERTRADE",
        "function27": "BARTYPE",
        "function270": "QUARTERTRADE1",
        "function271": "RAND",
        "function272": "RANGE",
        "function273": "RAWDATA",
        "function274": "REF",
        "function275": "REFLINE",
        "function276": "REFLINE1",
        "function277": "REFSIG_PLACE",
        "function278": "REFSIG_PRICE",
        "function279": "REFSIG_PRICE1",
        "function28": "BETWEEN",
        "function280": "REFSIG_PRICE2",
        "function281": "REFSIG_VOL",
        "function282": "REFWH",
        "function283": "REVERSE",
        "function284": "ROUND",
        "function285": "SAR",
        ...
        "function289": "SELECT",
        "function29": "BKHIGH",
        "function290": "SETDEALPERCENT",
        "function291": "SETEXPIREDATE",
        "function292": "SETMOVEOPIPRICE",
        "function293": "SETQUOTACCOUNT",
        "function294": "SETSIGPRICE",
        "function295": "SETSIGPRICETYPE",
        "function296": "SETSTYLECOLOR",
        "function297": "SETTLE",
        "function298": "SETTRADEACCOUNT",
        "function299": "SGN",
        "function3": "ADMA",
        "function30": "BKLOW",
        "function300": "SIGNUM",
        "function301": "SIGVOL",
        "function302": "SIN",
        "function303": "SKEWNESS",
        "function304": "SKHIGH",
        "function305": "SKLOW",
        "function306": "SKPRICE",
        "function307": "SKPRICE1",
        "function308": "SKPRICEAV",
        "function309": "SKPRICEAV1",
        "function31": "BKPRICE",
        "function310": "SKVOL",
        "function311": "SKVOL2",
        "function312": "SLOPE",
        ...
        "function319": "SPLIT",
        "function32": "BKPRICE1",
        "function320": "SPLITBARS",
        "function321": "SQRT",
        "function322": "SQUARE",
        "function323": "STD",
        "function324": "STDP",
        "function325": "STICK",
        "function326": "STICKLINE",
        "function327": "STICKLINE1",
        "function328": "STKTYPE",
        "function329": "STOCKDIVD",
        ...
        "function333": "T_MAX",
        "function334": "T_PLUS",
        "function335": "T0TOTIME",
        "function336": "TAN",
        "function337": "TAVLOSS",
        "function338": "TAVWIN",
        "function339": "TAVWINLOSS",
        "function34": "BKPRICEAV1",
        "function340": "TIME",
        "function341": "TIME0",
        "function342": "TIMETOT0",
        "function343": "TMAXLOSS",
        "function344": "TMAXSEQLOSS",
        "function345": "TMAXSEQWIN",
        "function346": "TMAXWIN",
        "function347": "TNUMSEQLOSS",
        "function348": "TNUMSEQWIN",
        "function349": "TODAYDEUCETIMES",
        "function35": "BKVOL",
        "function350": "TODAYLOSSTIMES",
        "function351": "TODAYWINTIMES",
        "function352": "TPROFIT_REF",
        "function353": "TRACING_ORDER",
        "function354": "TRADE_AGAIN",
        "function355": "TRADE_OTHER",
        "function356": "TRADE_REF",
        "function357": "TRADE_SMOOTHING",
        "function358": "TREND",
        "function359": "TRMA",
        "function36": "BKVOL2",
        "function360": "TSEQLOSS",
        "function361": "TSEQWIN",
        "function362": "TSMA",
        "function363": "UNIT",
        "function364": "UNIT1",
        "function365": "UNITLIMIT",
        "function366": "VALIGN",
        "function367": "VALUEWHEN",
        "function368": "VAR",
        "function369": "VARP",
        "function37": "BUYPRICE",
        "function370": "VERTLINE",
        "function371": "VERTLINE1",
        "function372": "VOL",
        "function373": "VOLATILITY",
        "function374": "VOLMARGIN",
        "function375": "VOLSTICK",
        "function376": "VOLTICK",
        "function377": "VOLTIME",
        "function378": "VOLUMESTICK",
        "function379": "WEEKDAY",
        "function38": "CEILING",
        "function380": "WEEKTRADE",
        "function381": "WEEKTRADE1",
        "function382": "WINNER",
        "function383": "WORD",
        "function384": "YCLOSE",
        "function385": "YEAR",
        "function386": "YEARTRADE",
        "function387": "YEARTRADE1",
        "function388": "YSETTLE",
        "function389": "#CALL",
        "function39": "CHECKSIG",
        "function390": "#CALL_OTHER",
        "function391": "#CALL_PLUS",
        "function392": "#IMPORT",
        "function393": "$",
        "function394": "$ $",
        "function4": "ALIGN",
        "function40": "CHECKSIG_MIN",
        "function41": "CIRCLEDOT",
        "function42": "CJLVOL",
        "function43": "CLOSE",
        "function44": "CLOSEKLINE",
        "function45": "CLOSEMINUTE",
        "function46": "CLOSEMINUTE1",
        "function47": "CLOSEMINUTEEVERY",
        "function48": "CLOSEMINUTEEVERY1",
        "function49": "CLOSESEC",
        "function5": "ASIN",
        "function50": "CLOSESEC1",
        "function51": "CLOSESECEVERY",
        "function52": "CLOSESECEVERY1",
        "function53": "CODELIKE",
        "function54": "COEFFICIENTR",
        "function55": "COLORSTICK",
        "function56": "CONDBARS",
        "function57": "COS",
        "function58": "COST",
        "function59": "COUNT",
        "function6": "ATAN",
        "function60": "COUNTGROUPSIG",
        "function61": "COUNTSIG",
        "function62": "COVAR",
        "function63": "CROSS",
        "function64": "CROSS2",
        "function65": "CROSSDOT",
        "function66": "CROSSDOWN",
        "function67": "CROSSUP",
        "function68": "CUBE",
        "function69": "CURRENTDATE",
        "function7": "AUTOFILTER",
        "function70": "CURRENTTIME",
        "function71": "DASH",
        "function72": "DASHDOT",
        "function73": "DASHDOTDOT",
        "function74": "DATE",
        "function75": "DATE1",
        "function76": "DAY",
        "function77": "DAYBARPOS",
        "function78": "DAYSTOEXPIRED",
        "function79": "DAYTRADE",
        "function8": "AUTOFINANCING",
        "function80": "DAYTRADE1",
        "function81": "DEVSQ",
        "function82": "DIVERGENCE",
        "function83": "DIVIDEND",
        "function84": "DIVIDENDBARS",
        "function85": "DMA",
        "function86": "DOT",
        "function87": "DRAWBARLINE",
        "function88": "DRAWBKBMP",
        "function89": "DRAWBMP",
        "function9": "AVAILABLE_OPI",
        "function90": "DRAWCOLORKLINE",
        "function91": "DRAWCOLORLINE",
        "function92": "DRAWCOLUMNCHART",
        "function93": "DRAWGBK",
        "function94": "DRAWGBK1",
        "function95": "DRAWICON",
        "function96": "DRAWKLINE",
        "function97": "DRAWKLINE1",
        "function98": "DRAWKLINE2",
        "function99": "DRAWLASTBARICON"
    },
    "FUNCTION_TYPE": {
        "NUM": 16,
        "type1": "K线数据引用",
    ...
    "GROUPBKPRICE": {
        ...
        "modifytime": "",
        "param": "",
        "tip": "GROUPBKPRICE('X'),X为指令分组组别，A-I返回分组指令X组最近一次模型买开位置的买开信号价位",
        "type": 10
    },
    "GROUPBKVOL": {
        "body": "BKVOL",
        ...
        "modifytime": "",
        "param": "",
        "tip": "GROUPBKVOL('X'),X为指令分组组别，A-I取指令分组模型X组的模组多头持仓.",
        "type": 10
    },
    "GROUPSKPRICE": {
        "body": "GROUPSKPRICE",
        ...
        "modifytime": "",
        "param": "",
        "tip": "GROUPSKPRICE('X'),X为指令分组组别，A-I,返回分组指令X组最近一次模型卖开位置的卖开信号价位",
        "type": 10
    },
    "GROUPSKVOL": {
        "body": "GROUPSKVOL",
        ...
        "modifytime": "",
        "param": "",
        "tip": "GROUPSKVOL('X'),X为指令分组组别，A-I取指令分组模型X组的模组空头持仓.",
        "type": 10
    },
    "H": "H 最高价",
    "HARMEAN": {
        ...
        "modifytime": "",
        "param": "",
        "tip": "HARMEAN(X,N)求X在N个周期内的调和平均值",
        "type": 2
    },
    "HASTRADEDATA": {
        "body": "HASTRADEDATA",
        ...
        "modifytime": "",
        "param": "",
        "tip": "HASTRADEDATA判断数据合约当根K线交易合约是否有数据",
        "type": 5
    },
    "HHV": {
        "body": "HHV( , )",
    ...
    "HHVBARS": {
        ...
        "modifytime": "",
        "param": "",
        "tip": "HHVBARS(X,N),求N周期内X最高值到当前周期数",
        "type": 2
    },
    "HIGH": {
        "body": "HIGH",
    ...
    "HISEXPDATE": {
        ...
        "modifytime": "20230707",
        "param": "",
        "tip": "HISEXPDATE返回当前周期期货合约的最后交易日",
        "type": 7
    },
    "HISEXPDAYS": {
        "body": "HISEXPDAYS",
        ...
        "modifytime": "20220425",
        "param": "",
        "tip": "HISEXPDAYS返回当前周期期货合约距离最后交易日的天数",
        "type": 7
    },
    "HOLLOW": {
        "body": "HOLLOW",
    ...
    "HV": {
        ...
        "modifytime": "",
        "param": "",
        "tip": "HV(X,N)求X在N个周期内的最高值(不包含当前K线)",
        "type": 2
    },
    "ICON": {
        "body": "ICON( , )",
        ...
        "modifytime": "",
        "param": "",
        "tip": "ICON(TYPE,ICON),在k线图上，显示小图标当TYPE为1，则在K线最高价位置显示图标ICON当TYPE为0，则在K线最低价位置显示图标ICON",
        "type": 8
    },
    "IDLE": {
        "body": "IDLE()",
    ...
    "ISCONTRACT": {
        ...
        "modifytime": "",
        "param": "",
        "tip": "ISCONTRACT('CODE')当前是否为指定的合约",
        "type": 5
    },
    "ISDELIVERYDAY": {
        "body": "ISDELIVERYDAY",
        "createtime": "",
        "description": "ISDELIVERYDAY 判断该周期是否是最后交易日。当前k线是最后交易日则返回1(Yes)，否则返回0(No)\\r\\n\\r\\n注：\\r\\n1、只能使用在日线及小于日线的周期，在周线月线等大于日线的周期使用时返回值始终为0。\\r\\n2、该函数应加载在可交易合约上。\\r\\n3、该函数加载到主连合约上按照对应的主力合约的最后交易日期进行判断，因此不能在主连合约上使用。\\r\\n\\r\\n例1：\\r\\nISDELIVERYDAY=1&&TIME>=1000,CLOSEOUT;//当根k线是最后交易日并且时间是10:00,全平。",
        "explanation": "判断该周期是不是最后交易日",
        "markettype": 1,
        "modifytime": "20230707",
        "param": "",
        "tip": "ISDELIVERYDAY,判断当根k线是否是最后交易日",
        "type": 5
    },
    "ISDOWN": {
        "body": "ISDOWN",
        ...
        "modifytime": "",
        "param": "",
        "tip": "ISDOWN,判断该周期是否收阴。如果为阴线返回1，否则返回0",
        "type": 5
    },
    "ISEQUAL": {
        "body": "ISEQUAL",
        ...
        "modifytime": "",
        "param": "",
        "tip": "ISEQUAL,判断该周期是否平盘，如果K线为平盘返回1，否则返回0",
        "type": 5
    },
    "ISLASTBAR": {
        "body": "ISLASTBAR",
        ...
        "modifytime": "",
        "param": "",
        "tip": "ISLASTBAR,判断是否是最后一个K线，如果为最后一根K线返回1，否则返回0",
        "type": 8
    },
    "ISLASTBK": {
        "body": "ISLASTBK",
    ...
    "ISLASTBPK": {
        ...
        "modifytime": "",
        "param": "",
        "tip": "ISLASTBPK，判断上一个指令是否是买平开",
        "type": 10
    },
    "ISLASTBUY": {
        "body": "ISLASTBUY",
        "createtime": "20221201",
        "description": "ISLASTBUY 判断上一个交易信号是否是BUY。\\r\\n\\r\\n用法：\\r\\nISLASTBUY 上一个交易信号是BUY则返回1（Yes），否则返回0（No）\\r\\n\\r\\n注：\\r\\n1、该函数支持在股票T+1策略运行池中使用。\\r\\n\\r\\n例:\\r\\nC>O,BUY;\\r\\nISLASTBUY&&C>BUYPRICE,SELL;\\r\\nAUTOFILTER;//上一个信号是BUY信号，且最新价大于买入价格，卖出持仓。",
        "explanation": "判断上一个交易信号是否是BUY",
        "markettype": 2,
        "modifytime": "20221205",
        "param": "",
        "tip": "ISLASTBUY 判断上一个交易信号是否是BUY。",
        "type": 10
    },
    "ISLASTCLOSEOUT": {
        "body": "ISLASTCLOSEOUT",
        ...
        "modifytime": "20220104",
        "param": "",
        "tip": "ISLASTCLOSEOUT，判断上一个指令是否是全平",
        "type": 10
    },
    "ISLASTKLINE": {
        "body": "ISLASTKLINE",
        ...
        "modifytime": "",
        "param": "",
        "tip": "ISLASTKLINE,判断该周期是否是当日收盘前最后一个K线，如果是返回1，否则返回0",
        "type": 5
    },
    "ISLASTSELL": {
        "body": "ISLASTSELL",
        "createtime": "20221201",
        "description": "ISLASTSELL判断上一个交易信号是否是SELL。\\r\\n\\r\\n用法：\\r\\nISLASTSELL 上一个交易信号是SELL则返回1（Yes），否则返回0（No）\\r\\n\\r\\n注：\\r\\n1、该函数支持在股票T+1策略运行池中使用。\\r\\n\\r\\n例:ISLASTSELL,BUY;//上一个信号是卖出信号，则买入。",
        "explanation": "判断上一个交易信号是否是SELL",
        "markettype": 2,
        "modifytime": "20221205",
        "param": "",
        "tip": "ISLASTSELL判断上一个交易信号是否是SELL。",
        "type": 10
    },
    "ISLASTSK": {
        "body": "ISLASTSK",
    ...
    "ISLASTSTOP": {
        ...
        "modifytime": "",
        "param": "",
        "tip": "ISLASTSTOP，判断上一个指令是否是STOP指令",
        "type": 10
    },
    "ISMAINCONTRACT": {
        "body": "ISMAINCONTRACT",
    ...
    "ISNEARHOLIDAY": {
        ...
        "modifytime": "",
        "param": "",
        "tip": "ISNEARHOLIDAY，判断下一交易日是否是交易合约的节假日。",
        "type": 5
    },
    "ISNULL": {
        "body": "ISNULL",
        ...
        "modifytime": "",
        "param": "",
        "tip": "ISNULL(N)判断空值，如果N为空值返回1，否则返回0",
        "type": 5
    },
    "ISRECORDDAY": {
        "body": "ISRECORDDAY",
    ...
    "ISTIMETOKLINEEND": {
        ...
        "modifytime": "20220608",
        "param": "",
        "tip": "ISTIMETOKLINEEND(N)判断当前K线时间是否满足K线走完前N秒满足返回1，不满足返回0。参数N为秒数。",
        "type": 5
    },
    "ISUP": {
        "body": "ISUP",
        ...
        "modifytime": "",
        "param": "",
        "tip": "ISUP,判断该周期是否收阳，如果K线为阳线返回1，否则返回0",
        "type": 5
    },
    "ISWEEKEND": {
        "body": "ISWEEKEND",
    ...
    "KEYWORD": {
        ...
        "keyword101": "FONTSIZE37",
        "keyword102": "FONTSIZE38",
        "keyword103": "FONTSIZE39",
        "keyword104": "FONTSIZE40",
        "keyword105": "FONTSIZE41",
        "keyword106": "FONTSIZE42",
        "keyword107": "FONTSIZE43",
        "keyword108": "FONTSIZE44",
        "keyword109": "FONTSIZE45",
        "keyword11": "NEW_ORDER",
        "keyword110": "FONTSIZE46",
        "keyword111": "FONTSIZE47",
        "keyword112": "FONTSIZE48",
        "keyword113": "FONTSIZE49",
        "keyword114": "FONTSIZE50",
        "keyword115": "FONTSIZE51",
        "keyword116": "FONTSIZE52",
        "keyword117": "FONTSIZE53",
        "keyword118": "FONTSIZE54",
        "keyword119": "FONTSIZE55",
        "keyword12": "SIGPRICE_ORDER",
        "keyword120": "FONTSIZE56",
        "keyword121": "FONTSIZE57",
        "keyword122": "FONTSIZE58",
        "keyword123": "FONTSIZE59",
        "keyword124": "FONTSIZE60",
        "keyword125": "FONTSIZE61",
        "keyword126": "FONTSIZE62",
        "keyword127": "FONTSIZE63",
        "keyword128": "FONTSIZE64",
        "keyword129": "FONTSIZE65",
        "keyword13": "COLORRED",
        "keyword130": "FONTSIZE66",
        "keyword131": "FONTSIZE67",
        "keyword132": "FONTSIZE68",
        "keyword133": "FONTSIZE69",
        "keyword134": "FONTSIZE70",
        "keyword135": "FONTSIZE71",
        "keyword136": "FONTSIZE72",
        "keyword137": "CUSTOM_DAY",
        "keyword138": "CUSTOM_HOUR",
        "keyword139": "CUSTOM_MIN",
        "keyword14": "COLORGRAY",
        "keyword140": "CUSTOM_SEC",
        "keyword141": "STOP",
        "keyword142": "STICK1",
        "keyword143": "CANCEL_ORDER",
        "keyword144": "RATIO_CODE",
        "keyword145": "RATIO_ACCOUNT",
        "keyword146": "AND",
        "keyword147": "OR",
        "keyword148": "THEN",
        "keyword149": "BEGIN",
        "keyword15": "COLORGREEN",
        "keyword150": "END",
        "keyword151": "CLOSEOUT",
        "keyword152": "ELSE",
        "keyword153": "V",
        ...
        "keyword158": "SELL",
        "keyword16": "COLORBLUE",
        "keyword17": "COLORMAGENTA",
        "keyword18": "COLORYELLOW",
        "keyword19": "COLORLIGHTGREY",
        "keyword2": "H",
        "keyword20": "COLORLIGHTRED",
        "keyword21": "COLORLIGHTGREEN",
        "keyword22": "COLORLIGHTBLUE",
        "keyword23": "COLORBLACK",
        "keyword24": "COLORWHITE",
        "keyword25": "COLORCYAN",
        "keyword26": "OPISTICK",
        "keyword27": "BK",
        "keyword28": "SK",
        ...
        "keyword31": "BPK",
        "keyword32": "SPK",
        "keyword33": "LINETHICK1",
        "keyword34": "LINETHICK2",
        "keyword35": "LINETHICK3",
        "keyword36": "LINETHICK4",
        "keyword37": "LINETHICK5",
        "keyword38": "LINETHICK6",
        "keyword39": "LINETHICK7",
        "keyword4": "C",
        "keyword40": "MAX_VALUE",
        "keyword41": "MIN_VALUE",
        "keyword42": "MAX_POS",
        "keyword43": "MIN_POS",
        "keyword44": "MAX1_VALUE",
        "keyword45": "MIN1_VALUE",
        "keyword46": "MAX1_POS",
        "keyword47": "MIN1_POS",
        "keyword48": "SECONDMAX_VALUE",
        "keyword49": "SECONDMIN_VALUE",
        "keyword5": "SEC",
        "keyword50": "SECONDMAX_POS",
        "keyword51": "SECONDMIN_POS",
        "keyword52": "SECONDMAX1_VALUE",
        "keyword53": "SECONDMIN1_VALUE",
        "keyword54": "SECONDMAX1_POS",
        "keyword55": "SECONDMIN1_POS",
        "keyword56": "TIMES",
        "keyword57": "ADD",
        "keyword58": "AVERAGE",
        "keyword59": "ALIGN0",
        ...
        "keyword68": "PRECIS3",
        "keyword69": "PRECIS4",
        "keyword7": "PASSIVE_ORDER",
        "keyword70": "PRECIS5",
        "keyword71": "PRECIS6",
        "keyword72": "FONTSIZE8",
        "keyword73": "FONTSIZE9",
        "keyword74": "FONTSIZE10",
        "keyword75": "FONTSIZE11",
        "keyword76": "FONTSIZE12",
        "keyword77": "FONTSIZE13",
        "keyword78": "FONTSIZE14",
        "keyword79": "FONTSIZE15",
        "keyword8": "ACTIVE_ORDER",
        "keyword80": "FONTSIZE16",
        "keyword81": "FONTSIZE17",
        "keyword82": "FONTSIZE18",
        "keyword83": "FONTSIZE19",
        "keyword84": "FONTSIZE20",
        "keyword85": "FONTSIZE21",
        "keyword86": "FONTSIZE22",
        "keyword87": "FONTSIZE23",
        "keyword88": "FONTSIZE24",
        "keyword89": "FONTSIZE25",
        "keyword9": "CMPETITV_ORDER",
        "keyword90": "FONTSIZE26",
        "keyword91": "FONTSIZE27",
        "keyword92": "FONTSIZE28",
        "keyword93": "FONTSIZE29",
        "keyword94": "FONTSIZE30",
        "keyword95": "FONTSIZE31",
        "keyword96": "FONTSIZE32",
        "keyword97": "FONTSIZE33",
        "keyword98": "FONTSIZE34",
        "keyword99": "FONTSIZE35"
    },
    "KLINESIG": {
        "body": "KLINESIG",
        "createtime": "20140904",
    ...
    "KLINESTART": {
        ...
        "modifytime": "",
        "param": "",
        "tip": "KLINESTART,判断K线当前状态是否是K线开始",
        "type": 5
    },
    "KTEXT": {
        "body": "KTEXT( , , , , ,)",
        ...
        "markettype": 0,
        "modifytime": "",
        "param": "POSITION参数负数代表向前移动0代表满足条件当根K线正数代表向后移动LCR代表显示在字符位置的左右中位置，0为左，1为中，2为右",
        "tip": "KTEXT(COND,POSITION,PRICE,LCR,COLOR,TEXT)在k线上标注文字当COND条件满足时,移动POSITION根K线,在PRICE位置书写COLOR色文字TEXTLCR是文字占K线左(0)中(1)右(2)位置",
        "type": 8
    },
    "KURTOSIS": {
        "body": "KURTOSIS( , )",
        ...
        "modifytime": "",
        "param": "",
        "tip": "KURTOSIS(X,N)求X在N个周期内的峰度系数",
        "type": 3
    },
    "K_STATE": {
        "body": "K_STATE()",
    ...
    "LAST": {
        ...
        "modifytime": "",
        "param": "",
        "tip": "LAST(X,N1,N2),判断过去N1到N2周期内，是否一直满足条件X一直满足返回1，否则返回0",
        "type": 5
    },
    "LASTOFFSETPROFIT": {
        ...
        "modifytime": "20240220",
        "param": "",
        "tip": "LASTOFFSETPROFIT最近一次交易的平仓盈亏",
        "type": 12
    },
    "LASTSIG": {
        "body": "LASTSIG",
        "createtime": "2015-07-01",
    ...
    "LASTSIGGROUP": {
        ...
        "modifytime": "20211230",
        "param": "",
        "tip": "LASTSIGGROUP判断最近一个信号所在的分组",
        "type": 10
    },
    "LIMIT_ORDER": "LIMIT_ORDER 市价",
    "LINETHICK": {
        "body": "LINETHICK",
        "createtime": "20140408",
    ...
    "LINETHICK1": "LINETHICK1 实线 粗细度为1",
    "LINETHICK2": "LINETHICK2 实线 粗细度为2",
    "LINETHICK3": "LINETHICK3 实线 粗细度为3",
    "LINETHICK4": "LINETHICK4 实线 粗细度为4",
    "LINETHICK5": "LINETHICK5 实线 粗细度为5",
    "LINETHICK6": "LINETHICK6 实线 粗细度为6",
    "LINETHICK7": "LINETHICK7 实线 粗细度为7",
    "LLV": {
        "body": "LLV( , )",
        "createtime": "",
    ...
    "LLVBARS": {
        ...
        "modifytime": "",
        "param": "。",
        "tip": "LLVBARS(X,N),求N周期内X最低值到当前周期数",
        "type": 2
    },
    "LN": {
        "body": "LN( )",
    ...
    "LONGCROSS": {
        ...
        "modifytime": "",
        "param": "",
        "tip": "LONGCROSS(A,B,N),判断A在是否在N个周期内都小于B如果是则返回1，否则返回0",
        "type": 5
    },
    "LOOP1": {
        "body": "LOOP1( , , )",
        ...
        "modifytime": "",
        "param": "",
        "tip": "LOOP1(X,N,TYPE)循环统计函数；对变量X在N个周期进行TYPE相应的操作",
        "type": 6
    },
    "LOOP2": {
        "body": "LOOP2( , , )",
        ...
        "modifytime": "",
        "param": "",
        "tip": "LOOP2(COND,A,B);循环条件函数；若COND条件成立，则返回A，否则返回B",
        "type": 6
    },
    "LOW": {
        "body": "LOW",
    ...
    "LV": {
        ...
        "modifytime": "",
        "param": "",
        "tip": "LV(X,N)求X在N个周期内的最小值(不包含当前K线)",
        "type": 2
    },
    "MA": {
        "body": "MA( , )",
    ...
    "MARGIN": {
        ...
        "modifytime": "20240201",
        "param": "",
        "tip": "MARGIN返回国内期货合约合约的保证金比率或者外盘期货合约的每手保证金",
        "type": 12
    },
    "MARKET_TYPE": {
        "NUM": 4,
        "markettype0": "markettype=0的函数（基础函数）",
        "markettype1": "markettype=1的函数（T+0策略函数）",
        "markettype2": "markettype=2的函数（T+1策略函数）",
        "markettype3": "markettype=3的函数（选股函数）"
    },
    "MAX": {
        "body": "MAX( , )",
        "createtime": "",
    ...
    "MAX1": {
        ...
        "modifytime": "",
        "param": "",
        "tip": "MAX1(A1,...,A30),取A1...A30中的最大值（支持2-30个参数进行比较）",
        "type": 4
    },
    "MAX1_POS": "MAX1_POS 最大值位置(不包括自身周期)",
    "MAX1_VALUE": "MAX1_VALUE 最大值（不包括自身周期）",
    "MAXBKVOL": {
        "body": "MAXBKVOL",
        "createtime": "20141216",
        ...
        "modifytime": "",
        "param": "",
        "tip": "MAXBKVOL相邻两次多头持仓为0之间的多头最大持仓手数",
        "type": 10
    },
    "MAXSKVOL": {
        "body": "MAXSKVOL",
        ...
        "modifytime": "",
        "param": "",
        "tip": "MAXBKVOL相邻两次空头持仓为0之间的空头最大持仓手数",
        "type": 10
    },
    "MAX_POS": "MAX_POS 最大值位置",
    ...
    "MEDIAN1": {
        ...
        "modifytime": "",
        "param": "",
        "tip": "MEDIAN1(A1,..,A30),求A1...A30的中位数（支持最多30个参数）",
        "type": 4
    },
    "MIN": {
        "body": "MIN( , )",
    ...
    "MIN1": {
        ...
        "modifytime": "",
        "param": "",
        "tip": "MIN1(A1,...,A30),取A1...A30中的最小值（支持2-30个参数进行比较）",
        "type": 4
    },
    "MIN1_POS": "MIN1_POS 最小值位置（不包括自身周期）",
    "MIN1_VALUE": "MIN1_VALUE 最小值（不包括自身周期）",
    "MINPRICE": {
        "body": "MINPRICE",
        "createtime": "",
        ...
        "modifytime": "",
        "param": "",
        "tip": "MINPRICE,取数据合约的最小变动价位",
        "type": 1
    },
    "MINPRICE1": {
        "body": "MINPRICE1",
        "createtime": "",
        "description": "MINPRICE1  取交易合约的最小变动价位。\\r\\n用法：\\r\\nMINPRICE1; 取交易合约的最小变动价位。",
        "explanation": "交易合约的最小变动价位",
        "markettype": 1,
        "modifytime": "20221117",
        "param": "",
        "tip": "MINPRICE1,取交易合约的最小变动价位",
        "type": 1
    },
    "MINPRICED": {
        "body": "MINPRICED",
        ...
        "modifytime": "",
        "param": "",
        "tip": "MINPRICED(N),返回N所对应合约的最小变动价位N只能为文华码",
        "type": 1
    },
    "MINUTE": {
        "body": "MINUTE",
        ...
        "modifytime": "",
        "param": "",
        "tip": "MINUTE,取某个周期的分钟数（0-59）",
        "type": 7
    },
    "MIN_POS": "MIN_POS 最小值位置",
    ...
    "MONTHTRADE1": {
        ...
        "modifytime": "",
        "param": "",
        "tip": "MONTHTRADE1月内交易函数，且历史数据不参与计算。",
        "type": 9
    },
    "MULTSIG": {
        "body": "MULTSIG( , , , )",
        ...
        "modifytime": "20230208",
        "param": "",
        "tip": "MULTSIG(Sec1,Sec2,N,INTERVAL),设置一根k线多信号的指令价方式（TICK逐笔回测，可设置回测精度），开仓信号出信号Sec1秒下单，不复核；平仓信号出信号Sec2秒下单，不复核，一根K线最大的信号个数为N,INTERVAL代表数据时间间隔",
        "type": 13
    },
    "MULTSIG_MIN": {
        "body": "MULTSIG_MIN( , , )",
        ...
        "modifytime": "20220106",
        "param": "",
        "tip": "MULTSIG_MIN(min1,min2,N),设置一根k线多信号的指令价方式（逐分钟回测）开仓信号出信号min1分钟下单，不复核；平仓信号出信号min2分钟下单，不复核，一根K线最大的信号个数为N",
        "type": 13
    },
    "MV": {
        "body": "MV(,)",
    ...
    "NAMELIKE": {
        ...
        "modifytime": "20220628",
        "param": "",
        "tip": "NAMELIKE('')模糊股票名称函数。NAMELIKE('ST')判断股票名称是否含有ST。是返回1（YES）,不是返回0（NO）。",
        "type": 5
    },
    "NEWHBARS": {
        "body": "NEWHBARS( , )",
        ...
        "modifytime": "",
        "param": "",
        "tip": "NEWHBARS(X,N)求高于当前X的第N个X的距离",
        "type": 2
    },
    "NEWHBARS1": {
        "body": "NEWHBARS1( , , )",
        ...
        "modifytime": "",
        "param": "",
        "tip": "NEWHBARS1(X,Y,N)，计算高于当前X的第N个Y到现在K线的距离",
        "type": 2
    },
    "NEWLBARS": {
        "body": "NEWLBARS( , )",
        ...
        "modifytime": "",
        "param": "",
        "tip": "NEWLBARS(X,N)求低于当前X的第N个X的距离",
        "type": 2
    },
    "NEWLBARS1": {
        "body": "NEWLBARS1( , , )",
        ...
        "modifytime": "",
        "param": "",
        "tip": "NEWLBARS1(X,Y,N)，计算低于当前X的第N个Y到现在K线的距离",
        "type": 2
    },
    "NEW_ORDER": "NEW_ORDER 最新价",
    "NODRAW": {
        "body": "NODRAW",
        "createtime": "",
    ...
    "NORMPDF": {
        ...
        "modifytime": "20230224",
        "param": "",
        "tip": "NORMPDF(X,MU,SIGMA),返回参数为MU和SIGMA的正态分布密度函数在X处的值",
        "type": 3
    },
    "NOT": {
        "body": "NOT( )",
        ...
        "modifytime": "",
        "param": "",
        "tip": "NOT(X),不满足条件X，不满足条件X返回1，否则返回0",
        "type": 5
    },
    "NOTEXT": {
        "body": "NOTEXT",
    ...
    "NUMPOW": {
        ...
        "modifytime": "",
        "param": "",
        "tip": "NUMPOW(X,N,M),自然数幂方和X为基础变量，N为自然数，M为实数",
        "type": 2
    },
    "O": "O 开盘价",
    "OFFSETPROFIT": {
    ...
    "OPISTICK": "OPISTICK 画竖线，K线为阳线为红色，K线为阴线为青色",
    "OR": "",
    "PANZHENG": {
        "body": "PANZHENG",
        "createtime": "20141117",
        ...
        "modifytime": "20211130",
        "param": "",
        "tip": "PANZHENG,判断行情是否盘整，返回1时表示盘整，返回0时表示非盘整",
        "type": 5
    },
    "PARTLINE": {
        "body": "PARTLINE( , , )",
        ...
        "markettype": 0,
        "modifytime": "",
        "param": "COND为条件,DATE为数值，COLOR为颜色",
        "tip": "PARTLINE(COND,DATA,COLOR)条件COND满足时，以COLOR颜色的直线连接DATA各点",
        "type": 8
    },
    "PARTLINE1": {
        "body": "PARTLINE1( , )",
        ...
        "markettype": 0,
        "modifytime": "",
        "param": "COND为条件,DATA为数值",
        "tip": "PARTLINE1(COND,DATA)条件COND满足时，用直线段连接DATA各点",
        "type": 8
    },
    "PASSIVE_ORDER": "PASSIVE_ORDER 排队价",
    "PCRATE": {
        "body": "PCRATE(,)",
        "createtime": "20220825",
    ...
    "PERCENTILE": {
        ...
        "modifytime": "",
        "param": "",
        "tip": "PERCENTILE(Data,N,Per)百分位函数取最近N个周期Data数据处于Per百分位的数值。Data为需要排序的数据，N为需要排序的周期数，Per是百分位数值。",
        "type": 2
    },
    "PERIOD": {
        "body": "PERIOD",
    ...
    "PLAYSOUND": {
        ...
        "modifytime": "",
        "param": "",
        "tip": "PLAYSOUND(COND,N),条件COND满足时播放指定声音N为自定义声音代码(可在设置声音文件中设置)",
        "type": 8
    },
    "POINTDOT": {
        "body": "POINTDOT",
    ...
    "POLYLINE": {
        ...
        "modifytime": "",
        "param": "COND为条件,DATE为数值，COLOR为颜色",
        "tip": "POLYLINE(COND,DATA,COLOR)，条件满足时，用颜色COLOR的直线连接DATA的值",
        "type": 8
    },
    "POLYLINE1": {
        "body": "POLYLINE1( , )",
        ...
        "markettype": 0,
        "modifytime": "",
        "param": "COND为条件,DATE为数值",
        "tip": "POLYLINE1(COND,DATA)，条件满足时，用折线连接DATA的值",
        "type": 8
    },
    "POW": {
        "body": "POW( , )",
    ...
    "PRECIS0": "PRECIS0 数值精度为0（不显示小数）",
    "PRECIS1": "PRECIS1 数值精度为1（显示1位小数）",
    "PRECIS2": "PRECIS2 数值精度为2（显示2位小数）",
    "PRECIS3": "PRECIS3 数值精度为3（显示3位小数）",
    "PRECIS4": "PRECIS4 数值精度为4（显示4位小数）",
    "PRECIS5": "PRECIS5 数值精度为5（显示5位小数）",
    "PRECIS6": "PRECIS6 数值精度为6（显示6位小数）",
    "PRECISION": {
        "body": "PRECISION",
        "createtime": "20160927",
    ...
    "QUARTERTRADE1": {
        ...
        "modifytime": "",
        "param": "",
        "tip": "QUARTERTRADE1季内交易函数，且历史数据不参与计算。",
        "type": 9
    },
    "RAND": {
        "body": "RAND",
        ...
        "modifytime": "",
        "param": "",
        "tip": "RAND(X,Y)产生随机数的随机函数,返回范围在X到Y之间的随机数。",
        "type": 4
    },
    "RANGE": {
        "body": "RANGE( , , )",
        ...
        "modifytime": "",
        "param": "",
        "tip": "RANGE(A,B,C),判断是否A大于B同时小于C，如果是则返回1，否则返回0",
        "type": 4
    },
    "RATIO_ACCOUNT": "RATIO_ACCOUNT 账户资金使用率",
    "RATIO_CODE": "RATIO_CODE 单品种资金使用率",
    "RAWDATA": {
        "body": "RAWDATA(  )",
        "createtime": "20160722",
    ...
    "REFSIG_PLACE": {
        ...
        "modifytime": "",
        "param": "",
        "tip": "REFSIG_PLACE(Sig,N)判断从当根K线开始倒数第N个固定的Sig信号所在K线的位置",
        "type": 10
    },
    "REFSIG_PRICE": {
        "body": "REFSIG_PRICE( , )",
        ...
        "modifytime": "",
        "param": "",
        "tip": "REFSIG_PRICE(Sig,N)返回从当根K线开始倒数第N个固定的Sig信号的信号价位",
        "type": 10
    },
    "REFSIG_PRICE1": {
        "body": "REFSIG_PRICE1( , )",
        ...
        "modifytime": "",
        "param": "",
        "tip": "REFSIG_PRICE1(Sig,N)返回从当根K线开始倒数第N个固定的Sig信号的委托价格",
        "type": 10
    },
    "REFSIG_PRICE2": {
        "body": "REFSIG_PRICE2( , )",
        ...
        "modifytime": "",
        "param": "",
        "tip": "REFSIG_PRICE2(Sig,N)返回从当根K线开始倒数第N个固定的Sig信号的成交价格",
        "type": 10
    },
    "REFSIG_VOL": {
        "body": "REFSIG_VOL( , )",
        ...
        "modifytime": "",
        "param": "",
        "tip": "REFSIG_VOL(Sig,N)返回从当根K线开始倒数第N个固定的Sig信号的信号手数(反手指令取开仓手数)",
        "type": 10
    },
    "REFWH": {
        "body": "REFWH( , )",
    ...
    "SAR": {
        ...
        "modifytime": "",
        "param": "",
        "tip": "SAR(N,Step,Max)，取抛物转向值N为周期数，Step为步长，Max为极值",
        "type": 2
    },
    "SAR1": {
        "body": "SAR1( , , )",
        ...
        "modifytime": "",
        "param": "",
        "tip": "SAR1(N,Step,Max)，取抛物转向值N为周期数，Step为步长，Max为极值",
        "type": 2
    },
    "SCALE": {
        "body": "SCALE",
        ...
        "modifytime": "",
        "param": "",
        "tip": "SCALE返回主动买占总成交量的比例",
        "type": 1
    },
    "SEC": "SEC 秒钟",
    "SECONDMAX1_POS": "SECONDMAX1_POS 次大值位置（不包括自身周期）",
    "SECONDMAX1_VALUE": "SECONDMAX1_VALUE 次大值（不包括自身周期）",
    "SECONDMAX_POS": "SECONDMAX_POS 次大值位置",
    "SECONDMAX_VALUE": "SECONDMAX_VALUE 次大值",
    "SECONDMIN1_POS": "SECONDMIN1_POS 次小值位置（不包括自身周期）",
    "SECONDMIN1_VALUE": "SECONDMIN1_VALUE 次小值（不包括自身周期）",
    "SECONDMIN_POS": "SECONDMIN_POS 次小值位置",
    "SECONDMIN_VALUE": "SECONDMIN_VALUE 次小值",
    "SEEK": {
        "body": "Seek",
        "createtime": "20180130",
        ...
        "modifytime": "",
        "param": "",
        "tip": "SEEK(Cond)标签统计函数Cond为需要满足的条件",
        "type": 2
    },
    "SELECT": {
        "body": "SELECT",
    ...
    "SETEXPIREDATE": {
        ...
        "modifytime": "",
        "param": "",
        "tip": "SETEXPIREDATE('yyyymmdd')设置加密模型的使用有效期的到期时间",
        "type": 14
    },
    "SETMOVEOPIPRICE": {
        ...
        "modifytime": "20220610",
        "param": "",
        "tip": "SETMOVEOPIPRICE(PRICE),设置模组换月移仓的委托方式，PRICE为价格方式",
        "type": 11
    },
    "SETQUOTACCOUNT": {
        "body": "SETQUOTACCOUNT()",
    ...
    "SETSTYLECOLOR": {
        ...
        "modifytime": "",
        "param": "",
        "tip": "SETSTYLECOLOR(LINETHICK,COLOR);设置线型的粗细和颜色LINETHICK表示线形的粗细，可以使用LINETHICK1——LINETHICK7；COLOR为颜色",
        "type": 8
    },
    "SETTLE": {
        "body": "SETTLE",
    ...
    "SGN": {
        ...
        "modifytime": "",
        "param": "",
        "tip": "SGN(X)，判断X正负数（若X>0返回1,若X<0返回-1,否则返回0）",
        "type": 4
    },
    "SIGNUM": {
        "body": "SIGNUM",
        ...
        "modifytime": "",
        "param": "",
        "tip": "SIGNUM，返回值为当前信号为一次交易过程中的第几个信号",
        "type": 10
    },
    "SIGPRICE_ORDER": "SIGPRICE_ORDER 触发价",
    "SIGVOL": {
        "body": "SIGVOL()",
        "createtime": "20151210",
        ...
        "modifytime": "",
        "param": "",
        "tip": "SIGVOL(N),返回一次交易中第N个信号的下单手数",
        "type": 10
    },
    "SIN": {
        "body": "SIN( )",
    ...
    "SKEWNESS": {
        ...
        "modifytime": "",
        "param": "",
        "tip": "SKEWNESS(X,N)求X在N个周期内的偏度系数",
        "type": 3
    },
    "SKHIGH": {
        "body": "SKHIGH",
    ...
    "SMA": {
        ...
        "modifytime": "",
        "param": "",
        "tip": "SMA(X,N,M)，求X的N个周期内的扩展指数加权移动平均。M为权重，N为周期数",
        "type": 2
    },
    "SMMA": {
        "body": "SMMA(,)",
        ...
        "modifytime": "",
        "param": "",
        "tip": "SMMA(X,N),表示当前K线上X在N个周期的通畅移动平均线",
        "type": 2
    },
    "SOLID": {
        "body": "SOLID",
    ...
    "SORT": {
        ...
        "modifytime": "",
        "param": "",
        "tip": "SORT(TYPE,POS,N1,N2,...,N30);按升(降)序排列，取第POS个参数对应的数值",
        "type": 2
    },
    "SORTPOS": {
        "body": "SORTPOS",
        ...
        "modifytime": "",
        "param": "",
        "tip": "SORTPOS(Type,POS,N1,N2,...,N30);按升(降)序排列，取第POS个参数的原始位置",
        "type": 2
    },
    "SOUND": {
        "body": "SOUND( )",
    ...
    "SPLIT": {
        ...
        "modifytime": "",
        "param": "",
        "tip": "SPLIT(N)返回之前第N次除权(送股或配股)的除权比例",
        "type": 15
    },
    "SPLITBARS": {
        "body": "SPLITBARS()",
        ...
        "modifytime": "",
        "param": "",
        "tip": "SPLITBARS(N)返回从之前第N次除权到当前的周期数",
        "type": 15
    },
    "SQRT": {
        "body": "SQRT( )",
    ...
    "STICK": {
        ...
        "modifytime": "",
        "param": "",
        "tip": "STICK(COND,P1,P2,N,COLOR,Empty);画指定粗细的柱线当满足COND时，在P1与P2之间画一条粗细为N、颜色为COLOR的柱状图若Empty不为0，则为空心柱；Empty为0，则为实心柱；N取值0-9",
        "type": 8
    },
    "STICK1": "STICK1，画柱线",
    "STICKLINE": {
        ...
        "markettype": 0,
        "modifytime": "",
        "param": "颜色为Color。若Empty不为0，则为空心柱",
        "tip": "STICKLINE(C,P1,P2,Color,Empty)当C条件满足时，从P1画到P2柱线",
        "type": 8
    },
    "STICKLINE1": {
        "body": "STICKLINE1( , , , , )",
        ...
        "modifytime": "",
        "param": "",
        "tip": "STICKLINE1(C,P1,P2,Width,Empty)当C条件满足时，从P1画到P2柱线，Width为宽度，若Empty不为0，则为空心柱",
        "type": 8
    },
    "STKTYPE": {
        "body": "STKTYPE",
        ...
        "modifytime": "",
        "param": "",
        "tip": "STKTYPE取市场类型，1为国内股票、2为美国股票、6为外汇、7为国内期货、8为国内期权、9为外盘、5为其它",
        "type": 5
    },
    "STOCKDIVD": {
        "body": "STOCKDIVD",
    ...
    "SUMBARS": {
        ...
        "modifytime": "",
        "param": "",
        "tip": "SUMBARS(X,A):求多少个周期的X向前累加能够大于等于A",
        "type": 2
    },
    "T0TOTIME": {
        "body": "T0TOTIME()",
        ...
        "modifytime": "",
        "param": "",
        "tip": "T0TOTIME(X)返回自该日0点以来的X秒处的时间。X可为变量或常数",
        "type": 7
    },
    "TAN": {
        "body": "TAN( )",
    ...
    "TIME": {
        ...
        "modifytime": "20230817",
        "param": "",
        "tip": "TIME取周期的时数，分钟周期表示为0900，秒周期表示为090000",
        "type": 7
    },
    "TIME0": {
        "body": "TIME0",
    ...
    "TIMETOT0": {
        ...
        "modifytime": "",
        "param": "",
        "tip": "TIMETOT0(X)返回时间X自该日0点以来的秒数。X可为变量或常数",
        "type": 7
    },
    "TMAXLOSS": {
        "body": "TMAXLOSS",
        "createtime": "20160302",
        "description": "TMAXLOSS 返回单次亏损最大额\\r\\n\\r\\n注：\\r\\n1、该函数返回交易以来，亏损最大的一次交易的亏损额\\r\\n2、从开仓到持仓为0被视为一次交易。\\r\\n3、收盘价模型，平仓盈亏=（平仓信号当根K线的收盘价-开仓价格）*手数*交易单位。\\r\\n指令价模型，平仓盈亏=（平仓信号的指令价-开仓价格）*手数*交易单位。\\r\\n4、TMAXLOSS的计算不包含手续费。\\r\\n5、因信号消失产生的盈亏未纳入TMAXLOSS的计算。\\r\\n\\r\\n例：\\r\\nMA5:MA(C,5);\\r\\nMA10:MA(C,10);\\r\\nCROSSUP(MA5,MA10),BK;\\r\\nCROSSDOWN(MA5,MA10),SP;\\r\\nIDLE(TMAXLOSS>1000);//单次最大亏损额大于1000限制开仓\\r\\nAUTOFILTER;",
        "explanation": "返回单次亏损最大额",
        "markettype": 1,
        "modifytime": "20240220",
        "param": "",
        "tip": "TMAXLOSS单次亏损最大额",
    ...
    "TRADE_AGAIN": {
        ...
        "modifytime": "20221206",
        "param": "",
        "tip": "TRADE_AGAIN(N),含有该函数的加减仓模型中,同一指令行可以连续出N个信号",
        "type": 9
    },
    "TRADE_OTHER": {
        "body": "TRADE_OTHER()",
        ...
        "modifytime": "20231213",
        "param": "",
        "tip": "TRADE_OTHER('CODE')，指定CODE合约为交易合约",
        "type": 11
    },
    "TRADE_REF": {
        "body": "TRADE_REF( )",
    ...
    "TREND": {
        ...
        "modifytime": "",
        "param": "",
        "tip": "TREND,获取K线趋势默认返回0，最高最低同时出现为1，最低先出现为2，最高先出现为3",
        "type": 5
    },
    "TRMA": {
        "body": "TRMA( , )",
    ...
    "TSMA": {
        ...
        "modifytime": "",
        "param": "",
        "tip": "TSMA(X,N)，求X在N周期内的时间序列三角移动平均",
        "type": 2
    },
    "T_CLOSE": {
        "body": "T_CLOSE",
        "createtime": "20221201",
        "description": "T_CLOSE 取交易合约收盘价。\\r\\n\\r\\n注：\\r\\n1、当盘中k线没有走完的时候，取交易合约最新价。\\r\\n\\r\\n例1：\\r\\nA:T_CLOSE;//定义变量A为交易合约收盘价（盘中k线没有走完的时候A为交易合约最新价）。",
        "explanation": "取交易合约收盘价",
        "markettype": 1,
        "modifytime": "20221206",
        "param": "",
        "tip": "T_CLOSE 取交易合约收盘价。",
        "type": 1
    },
    "T_MAX": {
        "body": "T_MAX",
        ...
        "modifytime": "",
        "param": "",
        "tip": "T_MAX(TYPE,N),根据设置的资金占用百分比计算模组最大可开仓手数，用于模组资金风控",
        "type": 12
    },
    "T_PLUS": {
        "body": "T_PLUS()",
        ...
        "modifytime": "20211230",
        "param": "",
        "tip": "T_PLUS(N)当条件满足时，过滤模型的开仓手数为默认手数",
        "type": 11
    },
    "UNIT": {
        "body": "UNIT",
        ...
        "modifytime": "",
        "param": "",
        "tip": "UNIT,取加载数据合约的交易单位",
        "type": 1
    },
    "UNIT1": {
        "body": "UNIT1",
        "createtime": "",
        "description": "UNIT1  取交易合约的交易单位。\\r\\n用法：\\r\\nUNIT1 取交易合约的交易单位。",
        "explanation": "取交易合约的交易单位",
        "markettype": 1,
        "modifytime": "20221117",
        "param": "",
        "tip": "UNIT1,取交易合约的交易单位",
        "type": 1
    },
    "UNITLIMIT": {
        "body": "UNITLIMIT",
    ...
    "VALIGN": {
        ...
        "modifytime": "",
        "param": "",
        "tip": "VALIGN0,VALIGN1,VALIGN2,分别表示文字上对齐，居中对齐，下对齐",
        "type": 8
    },
    "VALIGN0": "VALIGN0 上对齐",
    "VALIGN1": "VALIGN1 居中对齐",
    "VALIGN2": "VALIGN2 下对齐",
    "VALUEWHEN": {
        "body": "VALUEWHEN( , )",
        "createtime": "",
        ...
        "modifytime": "",
        "param": "",
        "tip": "VALUEWHEN(COND,X)，取满足条件COND时的X值",
        "type": 5
    },
    "VAR": {
        "body": "VAR( , )",
    ...
    "VERTLINE": {
        ...
        "markettype": 0,
        "modifytime": "",
        "param": "COND为条件,COLOR为颜色",
        "tip": "VERTLINE(COND,COLOR)，条件COND满足时，以颜色COLOR画垂直线",
        "type": 8
    },
    "VERTLINE1": {
        "body": "VERTLINE1( )",
        ...
        "modifytime": "",
        "param": "COND为条件",
        "tip": "VERTLINE1(COND)条件COND满足时，画垂直线",
        "type": 8
    },
    "VOL": {
        "body": "VOL",
    ...
    "VOLSTICK": {
        ...
        "modifytime": "",
        "param": "",
        "tip": "VOLSTICK画柱线，K线为阳线为红色，K线为阴线为青色",
        "type": 8
    },
    "VOLTICK": {
        "body": "VOLTICK",
    ...
    "VOLUMESTICK": {
        ...
        "modifytime": "",
        "param": "",
        "tip": "VOLUMESTICK画柱线，K线为阳线为红色，K线为阴线为青色",
        "type": 8
    },
    "WEEK": "WEEK 周",
    "WEEKDAY": {
    ...
    "WEEKTRADE1": {
        ...
        "modifytime": "",
        "param": "",
        "tip": "WEEKTRADE1周内交易函数，且历史数据不参与计算。",
        "type": 9
    },
    "WINNER": {
        "body": "WINNER( )",
    ...
    "YEARTRADE1": {
        ...
        "modifytime": "",
        "param": "",
        "tip": "YEARTRADE1年内交易函数，且历史数据不参与计算。",
        "type": 9
    },
    "YSETTLE": {
        "body": "YSETTLE",
